  ...
  registerBlockType("stylish-real-estate-leads/lead-forms-picker", {
    ...
    edit: function(props) {
      ...
      let jsx = [/* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("img", { src: srel_data.logo }),
        /* @__PURE__ */ React.createElement("p", null, "The Real Estate Lead Form will show up on the page.")
      )];
      return jsx;
    },
    save() {
